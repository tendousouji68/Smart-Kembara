    ...
    <div class="table-responsive text-nowrap">
        <table class="table table-dark">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td class="rounded-start-bottom"><i class="icon-base bx bxl-bootstrap icon-md text-primary me-3"></i> <span>Bootstrap Project</span></td>
                    <td>Jerry Milton</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller">
        ...
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                <tr class="table-default">
                    <td><i class="icon-base bx bxl-sketch icon-md text-warning me-4"></i> <span>Sketch Project</span></td>
                    <td>Ronnie Shane</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller">
                ...
                <tr class="table-info">
                    <td><i class="icon-base bx bxl-bootstrap icon-md text-primary me-4"></i> <span>Latest Bootstrap</span></td>
                    <td>Perry Parker</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller">
                ...
                <tr class="table-light">
                    <td><i class="icon-base bx bxl-angular icon-md text-danger me-4"></i> <span>Angular UI</span></td>
                    <td>Ana Bell</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller">
                ...
                <tr class="table-dark">
                    <td class="rounded-start-bottom"><i class="icon-base bx bxl-bootstrap icon-md text-primary me-4"></i> <span>Bootstrap UI</span></td>
                    <td>Jerry Milton</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller">
                ...
                <tr>
                    <td colspan="5">
                        <table class="table mb-0 table-light">
                            ...
                            <tbody>
                                <tr>
                                    <td><i class="icon-base bx bxl-react icon-md text-info me-4"></i> <span class="fw-medium">React Project</span></td>
                                    <td>Barry Hunter</td>
                                    <td>
                                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller">
                                ...
                                <tr>
                                    <td><i class="icon-base bx bxl-vuejs icon-md text-success me-4"></i> <span class="fw-medium">VueJs Project</span></td>
                                    <td>Trevor Baker</td>
                                    <td>
                                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller">
