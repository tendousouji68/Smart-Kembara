            ...
            <div class="card-body">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="d-grid d-sm-flex p-4 border">
                        <img src="{{ asset('assets/img/elements/1.png') }}" alt="collapse-image" height="125" class="me-6 mb-sm-0 mb-2" />
                        <span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">
                    ...
                    <a href="{{ config('variables.documentation') }}/ui-collapse.html#horizontal-collapse" target="_blank">documentation</a>.
                </p>
                <p class="demo-inline-spacing">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 mb-2 mb-lg-0">
                        <div class="collapse multi-collapse" id="multiCollapseExample1">
                            <div class="d-grid d-sm-flex p-4 border">
                                <img src="{{ asset('assets/img/elements/2.png') }}" alt="collapse-image" height="125" class="me-6 mb-sm-0 mb-2" />
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                            <div class="d-grid d-sm-flex p-4 border">
                                <img src="{{ asset('assets/img/elements/3.png') }}" alt="collapse-image" height="125" class="me-6 mb-sm-0 mb-2" />
