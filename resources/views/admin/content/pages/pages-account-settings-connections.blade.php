    ...
    <div class="col-md-12">
        <div class="nav-align-top">
            <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('pages/account-settings-account') }}"><i class="icon-base bx bx-user icon-sm me-1_5"></i> Account</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-link-alt icon-sm me-1_5"></i> Connections</a>
                </li>
            </ul>
        </div>
        <div class="card">
                        ...
                        <div class="d-flex mb-4 align-items-center">
                            ...
                            <div class="flex-grow-1 row">
                                ...
                                <div class="col-5 text-end mt-sm-0 mt-2">
                                    <button class="btn btn-icon btn-outline-secondary"><i class="icon-base bx bx-link icon-md"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex mb-4 align-items-center">
                            ...
                            <div class="flex-grow-1 row">
                                ...
                                <div class="col-5 text-end mt-sm-0 mt-2">
                                    <button class="btn btn-icon btn-outline-danger"><i class="icon-base bx bx-trash icon-md"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex mb-4 align-items-center">
