      ...
      <div class="container">
        ...
        <li class="nav-item <?php echo ($currentPage == '../umrah.php' || $currentPage == '../travel.php' ? 'active' : ''); ?> dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item <?php echo ($currentPage == '../umrah.php' ? 'active' : ''); ?>" href="../umrah">Smart Umrah</a>
            <a class="dropdown-item <?php echo ($currentPage == '../travel.php' ? 'active' : ''); ?>" href="../travel">Smart Travel</a>
          </div>
        </li>
        <li class="nav-item">
          <a class="filled-button" href="registration">Pendaftaran</a>
        </li>
        </div>
      </div>
    </nav>
